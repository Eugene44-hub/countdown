...
console.log('proposed day:' + (((proArr.at(-1) * 31) - 7) + proposed.getDate()));
console.log('proposed day:' + (((current.getMonth() * 31) - 5) + current.getDate()));

console.log((((proArr.at(-1) * 31) - 7) + proposed.getDate()) - (((current.getMonth() * 31) - 5) + current.getDate()));
