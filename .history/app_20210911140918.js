...
console.log((((proArr.at(-1) * 31) - 7) + proposed.getDate()) - ((((current.getMonth() * 31) - 5) + current.getDate())); console.log(12 - proArr.at(-1)); console.log(24 - current.getHours()); console.log(60 - current.getMinutes()); console.log(60 - current.getSeconds());
