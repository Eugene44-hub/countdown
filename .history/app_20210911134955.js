...
console.log(((proArr.at(-1) * ) console.log(12 - proArr.at(-1)) console.log(24 - current.getHours()) console.log(60 - current.getMinutes()) console.log(60 - current.getSeconds())

            // let cal = proposed. - current;
            console.log(proposed) console.log(current.getMonth()) console.log(proArr.at(-1))
